...
方法：人体姿态模型找到每个人的头 → 按镜头、按人整段平滑头部大小和位置 → 在脸上画一个比脸小一圈的椭圆（约 0.9 倍头宽，以眼睛和鼻子为中心；只看得到耳朵和后脑时略大；转头前后各多留 0.25 秒）。
雕像判定：脸部中心没有肤色（按亚洲人肤色的色调与饱和度范围），并且识别把握度低或相对周围景物完全不动的轨迹，视为雕像/塑像，不遮，写进可疑片段。黑白视频不做此判定。
验收标准：稳定挡住眼睛（2026-09-22）；背影不遮、远处很小的人物不管（2026-09-23）；黑圈比脸小一圈、佛像等雕像不遮（2026-09-23 晚）。
